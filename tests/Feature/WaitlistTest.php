...
class WaitlistTest extends TestCase
{
    ...
    public function test_landing_page_describes_a_launch_notification_not_platform_access(): void
    {
        ...
        $this->assertStringContainsString('Get notified when we launch', $source);
        $this->assertStringContainsString('This does not create an account or give you platform access.', $source);
    }
