...
Route::middleware(['auth', 'active', 'verified'])->group(function (): void {
    ...
    Route::post('/dashboard/university/attendee-students/{registrationStudent}/check-in', [DashboardController::class, 'checkInUniversityAttendeeStudent'])->middleware('role:university')->name('dashboard.university.attendee-students.check-in');
    Route::post('/dashboard/university/attendee-students/{registrationStudent}/check-out', [DashboardController::class, 'checkOutUniversityAttendeeStudent'])->middleware('role:university')->name('dashboard.university.attendee-students.check-out');
    Route::post('/dashboard/university/attendee-students/{registrationStudent}/absent', [DashboardController::class, 'markUniversityAttendeeStudentAbsent'])->middleware('role:university')->name('dashboard.university.attendee-students.absent');
    Route::post('/dashboard/university/attendee-students/{registrationStudent}/not-arrived', [DashboardController::class, 'markUniversityAttendeeStudentNotArrived'])->middleware('role:university')->name('dashboard.university.attendee-students.not-arrived');
